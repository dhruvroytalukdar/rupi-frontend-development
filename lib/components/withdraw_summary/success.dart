...
class SuccessSection extends StatefulWidget {
  final String upiId;
  final String amount;
  const SuccessSection({Key? key, required this.upiId, required this.amount})
      : super(key: key);

  @override
  State<SuccessSection> createState() => _SuccessSectionState();
}

class _SuccessSectionState extends State<SuccessSection> {
