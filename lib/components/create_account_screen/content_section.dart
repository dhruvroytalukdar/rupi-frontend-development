        ...
        child: Column(
          ...
          children: [
            ...
            const SocialButton(
                ...
                button_key: Key("facebook_signup_button"),
                text: "Sign up with Facebook",
                iconAddr: "assets/icons/facebook.png",
                primaryColor: Color(0xff3b5998),
                textColor: Colors.white),
            const SizedBox(height: 20),
            const SocialButton(
                login_provider: "google",
                button_key: Key("google_signup_button"),
                text: "Sign up with Google",
                iconAddr: "assets/icons/google.jpg",
            ...
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                child: const Text(
                  "Sign up using Email/Phone Number",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 14.5,
                  ),
