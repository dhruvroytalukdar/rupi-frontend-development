...
void main() {
  testWidgets('Continue button is showing correctly or not.',
    ...
    // Get the widget
    final bankDetailsContinueState1Button =
  ...
  testWidgets('Account Number Text field is showing correctly or not.',
      (WidgetTester tester) async {
    // Get the widget
  ...
  testWidgets('Name Text field is showing correctly or not.',
      (WidgetTester tester) async {
    // Get the widget
