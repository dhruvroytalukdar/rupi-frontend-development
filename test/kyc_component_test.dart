...
void main(){
  ...
  testWidgets('KYC State 1 Continue button is showing correctly or not.', (WidgetTester tester) async {
    // Get the widget
  ...
  testWidgets('PAN Number Text field is showing correctly or not.', (WidgetTester tester) async {
    // Get the widget
